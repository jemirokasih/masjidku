...
## [v2.2.0] - 2026-08-30
### Added & Enhanced
- **Tampilan CRUD Table Mikrotek Theme pada Program DKM (`/content/program`)**:
  - Mengubah tampilan manajemen Program DKM di `ContentManagementPage.jsx` menjadi standar **Mikrotek Business Suite Enterprise CRUD Table Layout**.
  - Dilengkapi fitur **Search Bar** (pencarian nama/deskripsi program), **Category Filter Dropdown** (*Pendidikan Anak, Sosial & Layanan, Musiman, Kajian*), **Status Filter Dropdown** (*Aktif, Musiman, Selesai*), **Tabel Data Ber-badge**, dan **Pagination & Counter** (*Showing X-Y of Z entries*).
  - Dilengkapi **Modal Dialog Form** untuk Tambah / Edit Program DKM secara elegan dan responsif.
