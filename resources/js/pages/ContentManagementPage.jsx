...
import { 
    ...
    CheckCircle2, Save, Building, MapPin, Navigation, List
} from 'lucide-react';
...
export default function ContentManagementPage() {
    ...
    return (
        <div className="space-y-6 max-w-6xl mx-auto font-sans">
            ...
            {/* 9 CMS Section Tabs */}
            <div className="flex overflow-x-auto space-x-1 border-b border-slate-200 dark:border-slate-800 pb-1 scrollbar-thin">
                {tabs.map((t) => {
                    const Icon = t.icon;
                    return (
                        <button
                            ...
                            className={`px-3.5 py-2.5 rounded-xl text-xs font-bold transition whitespace-nowrap flex items-center space-x-1.5 shrink-0 ${
                                activeTab === t.id
