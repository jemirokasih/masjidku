                    ...
                    <div style="text-align: right; margin-left: auto; width: 170px;">
                        ...
                        @else
                            ...
                            <div style="text-align: right;">
                                <img src="{{ \App\Helpers\QrCodeGenerator::generateSvgDataUri(url('/portal/invoice/' . ($invoice->public_token ?? $invoice->invoice_number)), 85) }}" style="width: 75px; height: 75px; display: inline-block;" />
